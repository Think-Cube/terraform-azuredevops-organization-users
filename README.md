...
| <a name="requirement_azuredevops"></a> [azuredevops](#requirement\_azuredevops) | 1.15.0 |
...
| Name | Type |
|------|------|
| [azuredevops_user_entitlement.main](https://registry.terraform.io/providers/microsoft/azuredevops/1.15.0/docs/resources/user_entitlement) | resource |
